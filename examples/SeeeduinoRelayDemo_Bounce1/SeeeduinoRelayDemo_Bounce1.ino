...
// This version of the demo program uses the "Bounce1" (formerly just "Bounce") 
// debouncing library.  You don't need to have Bounce1 installed to use the library,
// just to use this demo program.
// If you are using Bounce1 with Arduino IDE 1.0 or later you must change the line
// in Bounce1/Bounce.cpp from:
// #include "WProgram.h"
// to 
// #include "Arduino.h"
// in order to have it compile. The Bounce2 library is compatible with Arduino 1.0+
